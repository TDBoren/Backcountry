...
dag_id = 'S5_interface_data_weekly'

## passing the default arguments
default_args = {
    'owner': 'S5',
    'depends_on_past': False,
    'start_date': datetime(year=2021, month=9, day=7, tzinfo=local_tz),
...
# Create a permanent table linked to the GCS file
    ...
    uri = "gs://{}/s5_source_files/Optimal Origin Facility for Dest Zip.CSV".format(target_bucket)
...
with DAG(dag_id, schedule_interval="0 6 * * 0",
         max_active_runs=1,
...
#Phase2 Changes
    ...
    load_NetworkZip_Stg_table = PythonOperator(
        task_id='load_NetworkZip_Stg_table',
        python_callable=load_table_from_gcs_to_bq,
        op_kwargs={'table_name': 'S5_NetworkZip_Stg'},
        provide_context=True
    )
...
load_Prod_Members_table >> load_Prod_Master_table >> load_Prod_Master_table_to_gcs
load_Prod_Members_table >> load_Prod_Org_table >> load_Prod_Attr_SKU_table >> load_Prod_Attr_SKU_table_to_gcs
load_Prod_Members_table >> load_Prod_Attr_Style_table >> load_Prod_Attr_Style_table_to_gcs
load_Prod_Members_table >> load_Prod_Attr_Style_Clr_table >> load_Prod_Attr_Style_Clr_table_to_gcs
load_Prod_Members_table >> load_ProdAttrSKUArray_table >> load_ProdAttrSKUArray_table_to_gcs
load_Prod_Members_table >> load_ImageURL_table >> load_ImageURL_table_to_gcs
load_Prod_Members_table >> load_Product_Hierarchy_table >> load_Product_Hierarchy_table_to_gcs
load_LocMembers_table >> load_NetworkLoc_table >> load_NetworkLoc_table_to_gcs >> load_NetworkZip_Stg_table >> load_NetworkZip_table >> load_NetworkZip_table_to_gcs
load_LocMembers_table >> load_Location_Attribute_table >> load_Location_Attribute_table_to_gcs >> load_LocMaster_table >> load_LocMaster_table_to_gcs >> load_Location_Hierarchy_table >> load_Location_Hierarchy_table_to_gcs
load_Location_Hierarchy_table_to_gcs >> load_SalesDaily_table >> load_SalesDaily_table_to_gcs >> load_Rejects_table
...
load_Rejects_table >> load_RDYFile_table >> load_RDYFile_table_to_gcs >> S5_to_S5_transfer >> trigger_email
[load_Prod_Master_table_to_gcs, load_Prod_Attr_SKU_table_to_gcs, load_Prod_Attr_Style_table_to_gcs, load_Prod_Attr_Style_Clr_table_to_gcs, load_ProdAttrSKUArray_table_to_gcs, load_ImageURL_table_to_gcs, load_Product_Hierarchy_table_to_gcs, load_NetworkZip_table_to_gcs, load_NetworkLoc_table_to_gcs, trigger_email] >> end_task
