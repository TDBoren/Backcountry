...
dag_id = 'S5_interface_data_daily'
...
with DAG(dag_id, schedule_interval="0 6 * * 1-6",
         max_active_runs=1,
...
load_Prod_Members_table >> load_ReplannableSKUs_table >> load_ReplannableSKUs_table_to_gcs
...
load_Location_Hierarchy_table_to_gcs >> load_SalesDaily_Daily_table >> load_SalesDaily_table_to_gcs >> load_Rejects_table
load_Location_Hierarchy_table_to_gcs >> load_Rejects_table
load_Location_Hierarchy_table_to_gcs >> load_OOActualsDaily_table >> load_OOActualsDaily_table_to_gcs >> load_Rejects_table
...
[load_Prod_Master_table_to_gcs, load_Prod_Attr_SKU_table_to_gcs, load_Prod_Attr_Style_table_to_gcs, load_Prod_Attr_Style_Clr_table_to_gcs, load_ProdAttrSKUArray_table_to_gcs, load_ImageURL_table_to_gcs, load_Product_Hierarchy_table_to_gcs, load_OOActualsDaily_table_to_gcs, load_ReplannableSKUs_table_to_gcs, trigger_email] >> end_task
